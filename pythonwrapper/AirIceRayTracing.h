...
#ifndef _INCLUDE_AIRICERAYTRACING_H_
#define _INCLUDE_AIRICERAYTRACING_H_
...
namespace AirIceRayTracing{
  
  static const double pi=4.0*atan(1.0); /**< Gives back value of Pi */
